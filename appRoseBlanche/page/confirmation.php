...
$updateStmt = $pdo->prepare("UPDATE Commandes SET idEtat = :idEtat WHERE idCommande = :idCommande");
$updateStmt->execute(['idEtat' => $newEtat, 'idCommande' => $idCommande ]);
