...
public class Commande {
    ...
    public String Etat;
    public float total_commande;
    public int nbPlats;
    public ArrayList<Ligne> lignes = new ArrayList<>();

    
    public Commande(int idCommande, int idUtilisateur, String date_commande, String Etat, int nbPlats, float total_commande, ArrayList<Ligne> lignes){
