...
public class Commande {
    ...
    public Commande(int idCommande, int idUtilisateur, String loginUtilisateur, String date_commande, String Etat, int nbPlats, String total_commande, ArrayList<Ligne> lignes){
